...
<!--                        <li><a class="section-scroll" href="--><?//= $route . Url::to('/') ?><!--">--><?//= Yii::t('main', 'Про нас') ?><!--</a></li>-->
                        <li><a class="section-scroll" href="<?= $route . '/' . Url::to('catalog') ?>"><?= Yii::t('main', 'Каталог') ?></a></li> <!--#works-->
<!--                        <li><a class="section-scroll" href="#alt-features">--><?//= Yii::t('main', 'Можливості') ?><!--</a></li>-->
                        <li><a class="section-scroll" href="<?= $route . '/' . Url::to('contact') ?>"><?= Yii::t('main', 'Контакт') ?></a></li>
